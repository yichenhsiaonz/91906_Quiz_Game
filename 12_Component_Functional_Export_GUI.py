    ...
    def __init__(self, partner):
        ...
        self.stats_text = Label(self.stats_frame, text="Points: {}\n"
                                                       ...
                                                       "{}".format(self.score, self.score,
                                                                   ...
                                                                   partner.rounds, leaderboard_list),
                                justify=LEFT,)
...
class Export:
    def __init__(self, partner):
        ...
        self.user_name_text = Label(self.entry_export_button_frame, text="Enter user name here")
        self.user_name_text.grid(row=0, column=0)
        ...
        self.file_name_text = Label(self.entry_export_button_frame, text="Enter file name here")
    ...
    def export(self, partner):
        ...
        if regex_check(file) == "No Error":
            ...
            if file.isfile():
                ...
                csv_file = open(
                    "Leaderboards/{}_{}_leaderboard.csv".format(partner.given_column, partner.answer_column), "a",
                    newline='')
                csv_file.close()

                csv_file = open("{}.csv".format(file), "a", newline='')
                leaderboard_list.sort(key=self.get_score, reverse=True)
                leaderboard_list.index("**** You: {} ****".format(partner.score))
