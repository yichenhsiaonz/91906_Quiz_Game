...
# sort key to sort by second entry in each object in list as each object is a list within a list
...
class Start:
    def __init__(self):
        ...
        self.start_frame = Frame(padx=5, pady=5, bg=self.bgc)
        self.start_frame.grid()

        # header text

        self.start_text = Label(self.start_frame, bg=self.bgc, text="Periodic Table Quiz", font=("Arial", "16", "bold"),
                                justify=LEFT, anchor="w")
        self.start_text.grid(row=0, pady=5, sticky=W)

        # instructions text

        self.instructions_text = Label(self.start_frame, justify=LEFT, bg=self.bgc,
        ...
        self.setup_quit_button_frame = Frame(self.start_frame, bg=self.bgc)
...
class Setup:
    def __init__(self, partner):
        ...
        self.setup_frame = Frame(self.setup_box, padx=10, pady=5, bg=self.bgc)
        ...
        self.setup_text = Label(self.setup_frame, text="Setup", font=("Arial", "16", "bold"), bg=self.bgc, anchor="w")
        self.setup_text.grid(row=0, pady=5, sticky=W)

        # instruction text

        self.instructions_text = Label(self.setup_frame, justify=LEFT, bg=self.bgc,
        ...
        self.top_label = Label(self.setup_frame, bg=self.bgc, text="Please select what you would like to practice")
        self.top_label.grid(row=2, pady=5)

        # frame for answer options

        self.answer_frame = Frame(self.setup_frame, bg=self.bgc)
        ...
        self.bottom_label = Label(self.setup_frame, bg=self.bgc, text="Please select what you would like to be given")
        self.bottom_label.grid(row=4, pady=5)

        # frame for given options

        self.given_frame = Frame(self.setup_frame, bg=self.bgc)
        ...
        self.play_quit_button_frame = Frame(self.setup_frame, bg=self.bgc)
...
class Play:
    def __init__(self, partner):
        ...
        self.play_frame = Frame(self.play_box, padx=5, pady=5, bg=self.bgc)
        self.play_frame.grid()

        # header text

        self.play_text = Label(self.play_frame, bg=self.bgc, text="Periodic Table Quiz", font=("Arial", "16", "bold"))
        self.play_text.grid(row=0)

        # Rounds played / points

        self.point_rounds_text = Label(self.play_frame, bg=self.bgc, text="Rounds played: 0 / 10\n"
                                                             "Points: 0")
        self.point_rounds_text.grid(row=1)

        # Instructions / question

        self.instruction_text = Label(self.play_frame, bg=self.bgc,
                                      text="Select the correct answer to the question below...\n\n"
        ...
        self.play_text_given = Label(self.play_frame, font=("Arial", "14"), bg=self.bgc)
        self.play_text_given.grid(row=3)

        # Option frame

        self.option_frame = Frame(self.play_frame, bg=self.bgc)
        ...
        self.save_text = Label(self.play_frame, bg=self.bgc,
                               text="To save your score to the leaderboard, export the\n"
                                    "leaderboard in the stats menu")
        self.save_text.grid(row=6)

        # frame for help / export buttons

        self.help_stats_button_frame = Frame(self.play_frame, bg=self.bgc)
    ...
    def next_pressed(self, partner):
        ...
        for x in self.option_list:
            ...
            x.configure(bg="white smoke", state=NORMAL)
...
class Help:
    def __init__(self, partner):
        ...
        self.help_frame = Frame(self.help_box, pady=5, bg=self.bgc)
        self.help_frame.grid()

        # header text

        self.help_text = Label(self.help_frame, bg=self.bgc, text="Help / Instructions", font=("Arial", "16", "bold"),
                               justify=LEFT, anchor="w")
        self.help_text.grid(row=0, sticky=W)

        # header text

        self.instruction_text = Label(self.help_frame, justify=LEFT, bg=self.bgc, width=40,
...
class Stats:
    def __init__(self, partner):
        ...
        self.stats_frame = Frame(self.stats_box, padx=5, pady=5, bg=self.bgc)
        self.stats_frame.grid()

        # header text

        self.stats_heading = Label(self.stats_frame, font=("Arial", "16", "bold"), justify=LEFT,
                                   anchor="w", bg=self.bgc)
        self.stats_heading.grid(row=0, sticky=W)

        if partner.rounds == 10:
            self.stats_heading.configure(text="Game Over!\nStats")
        else:
            self.stats_heading.configure(text="Stats")
        # space for text
        ...
        for x in self.leaderboard_list:
            ...
            if x == "*":
                self.leaderboard_text += "**** You: {} **** Export to save this score!\n".format(self.score)
        ...
        self.stats_text = Label(self.stats_frame, bg=self.bgc, text="Points: {}\n"
        ...
        self.export_quit_button_frame = Frame(self.stats_frame, bg=self.bgc)
...
class Export:
    def __init__(self, partner):
        ...
        self.export_frame = Frame(self.export_box, pady=5, bg=self.bgc)
        self.export_frame.grid()

        # header text

        self.export_text = Label(self.export_frame, text="Export", font=("Arial", "16", "bold"),
                                 anchor="w", justify=LEFT, bg=self.bgc)
        self.export_text.grid(row=0, sticky=W)

        # response label

        self.response_text = Label(self.export_frame, justify=LEFT, anchor="w", bg=self.bgc,
        ...
        self.entry_export_button_frame = Frame(self.export_frame, bg=self.bgc)
        ...
        self.response_text = Label(self.export_frame, text="", bg=self.bgc)
...
class OverwriteWarning:
    def __init__(self, partner, partner_2):
        ...
        self.warning_frame = Frame(self.warning_box, padx=10, pady=5, bg=self.bgc)
        self.warning_frame.grid()

        # header text

        self.warning_heading = Label(self.warning_frame, text="Overwrite Warning", bg=self.bgc)
        self.warning_heading.grid(row=0)

        # main text

        self.warning_text = Label(self.warning_frame, bg=self.bgc, text="The file '{}.txt' already exists.\n"
        ...
        self.yes_no_frame = Frame(self.warning_frame, bg=self.bgc)
